---
title: "Advanced: Customize MinimalPad Firmware"
sidebarTitle: "Advanced Customization"
description: "Edit the MinimalPad keymap source to change encoder rotation, create firmware macros, and modify compiled behavior beyond what Studio can do."
---

<Warning>
This page is for advanced users who need to modify the firmware source code. Most key customization — including assigning keys, managing layers, and controlling RGB — can be done without touching the firmware. Use [MinimalPad Studio](https://studio.minimalmacropad.com/configure) for everyday configuration. See [Firmware vs Studio](/firmware/firmware-and-studio) to decide which approach you need.
</Warning>

Some MinimalPad behaviors are compiled into the firmware and cannot be changed from the browser. To modify them, you edit the firmware source files, build new firmware using GitHub Actions, and flash the result to your device.
