...
`[Screenshot: Bootloader USB drive in file manager with UF2 file being copied]`
...
Open [MinimalPad Studio](https://studio.minimalmacropad.com/configure) in Chrome or Edge and connect your device. It should respond normally.
