...
MinimalPad Studio is a browser-based configurator at [studio.minimalmacropad.com](https://studio.minimalmacropad.com/). Connect your MinimalPad over USB or Bluetooth, and you can remap keys, manage layers, and control RGB — all in real time, with no firmware reflash required.
...
<CardGroup cols={2}>
  ...
  <Card title="Open Studio" icon="sliders" href="https://studio.minimalmacropad.com/">
