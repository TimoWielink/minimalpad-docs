...
<Steps>
  <Step title="Connect MinimalPad to Studio">
    Plug in your MinimalPad and open [https://studio.minimalmacropad.com/configure](https://studio.minimalmacropad.com/configure). Connect using USB or Bluetooth. See the [USB connection guide](/connecting/connect-usb) if needed.
  </Step>
