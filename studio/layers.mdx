---
title: "Use Layers to Multiply Your MinimalPad's Keys"
sidebarTitle: "Layers"
description: "Use layers in MinimalPad Studio to give the same 16 physical keys different actions in different contexts — like Shift on a full keyboard, but for everything."
---
...
`[Screenshot: Studio showing multiple layer tabs at the top of the interface]`
...
`[Screenshot: Studio showing the rename layer prompt]`
...
`[Screenshot: Studio showing layer activation actions in the action picker]`
